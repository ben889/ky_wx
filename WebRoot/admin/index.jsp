...
<link href="<%=basePath%>admin/css/skin.css" type="text/css"
	rel="stylesheet"></link>
...
<body class="indexbody">
	<div class="header">
		...
		<div class="nav-right">
			<div class="icon-info">
				<span><font class="fa fa-meh-o" style="font-size:18px;"></font>&nbsp;&nbsp;您好，【<s:property
						value="#user.username" />】&nbsp;&nbsp;<a href="javascript:;"
					onclick="return confirm('确定退出吗？');" style="color:#ffffff;">退出</a>
				</span>
			</div>
		</div>
	</div>
	...
	<div class="main-container">
		<iframe id="mainframe" name="mainframe" allowtransparency="true"
			src="" border="0" frameborder="0" framespacing="0" marginheight="0"
			marginwidth="0"
