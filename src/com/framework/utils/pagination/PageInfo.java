package com.framework.utils.pagination;
...
public class PageInfo {
   ...
   // protected  static final Logger log = Logger.getLogger("testLogger");
    ...
    public PageInfo(HttpServletRequest req) {
       this.currentPage = req.getParameter("page")!=null && !req.getParameter("page").equals("")?new Integer(req.getParameter("page")).intValue():1;
       this.pageSize = 10;
       if(this.pageSize<=0){
