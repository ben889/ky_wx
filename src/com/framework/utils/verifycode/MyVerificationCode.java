package com.framework.utils.verifycode;
...
public class MyVerificationCode {
	...
	public ByteArrayInputStream getVerificationCode() {
		BufferedImage image = new BufferedImage(WIDTH, HEIGHT,
				BufferedImage.TYPE_INT_RGB);
		int randomNum = new Random().nextInt(3);
		if (randomNum == 0) {
			return initNumVerificationCode(image);
		} else if (randomNum == 1) {
			return initLetterAndNumVerificationCode(image);
		} else {
			return initChinesePlusNumVerificationCode(image);
		}
	}
	 ...
	 * 功能：设置第一种验证码的属性
	 */
	public ByteArrayInputStream initNumVerificationCode(BufferedImage image) {
	 ...
	 * 功能：设置第二种验证码属性
	 */
	public ByteArrayInputStream initLetterAndNumVerificationCode(
			BufferedImage image) {
	 ...
	 */
	public ByteArrayInputStream initChinesePlusNumVerificationCode(
			BufferedImage image) {
